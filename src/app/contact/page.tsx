...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contact GoldHub for customer support, vendor onboarding or marketplace safety concerns.",
  alternates: { canonical: "/contact" },
};

const contacts = [
  { label: "Customer support", detail: "Questions about a reservation, price lock or listed product.", email: "support@goldhub.ae" },
  { label: "Vendor onboarding", detail: "Trade-licence verification and listing your UAE gold shop.", email: "vendors@goldhub.ae" },
  { label: "Safety & compliance", detail: "Report suspicious listings, payment requests or account activity.", email: "support@goldhub.ae" },
];
    ...
    <>
      <section className="bg-jade-950 text-white">
        <div className="container-pro py-14 sm:py-20">
          ...
          <h1 className="mt-3 max-w-2xl font-serif text-4xl font-semibold tracking-tight sm:text-6xl">Talk to the right GoldHub team.</h1>
      ...
      <div className="container-pro py-12 sm:py-16">
        ...
        <div className="mt-8 rounded-2xl border border-gold-400/25 bg-gold-50 p-5 text-sm leading-relaxed text-ink-muted sm:p-6">
          <strong className="text-jade-950">Payment safety:</strong> GoldHub never asks for card details, OTPs or bank credentials by email. A vendor remains the seller of record; verify the vendor name and reservation details before paying any link.
        </div>
