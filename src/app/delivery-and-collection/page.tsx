...
export default function DeliveryPolicyPage() {
  return <PolicyPage eyebrow="Receiving your order" title="Delivery & collection" intro="The listed vendor fulfils the order. Availability, handover method and any applicable delivery charge must be confirmed before payment." sections={[
    ...
    { title: "Tracking, delays and risk", paragraphs: ["An assigned company can accept or decline, schedule pickup, confirm collection, mark the parcel out for delivery and record delivery or a failed attempt. These updates appear in the customer’s order history.", "The vendor is responsible for the delivery method it selects and should explain insurance or loss coverage before dispatch. Get Gold should not be described as providing insured delivery unless a specific integrated service is shown in the reservation."] },
  ]} />;
}
