...
export const metadata: Metadata = { title: "Delivery & collection", description: "How delivery and shop collection work for GoldHub reservations.", alternates: { canonical: "/delivery-and-collection" } };
...
export default function DeliveryPolicyPage() {
  return <PolicyPage eyebrow="Receiving your order" title="Delivery & collection" intro="The listed vendor fulfils the order. Availability, handover method and any applicable delivery charge must be confirmed before payment." sections={[
    ...
    { title: "Delays and risk", paragraphs: ["The vendor is responsible for the delivery method it selects and should explain insurance or loss coverage before dispatch. GoldHub should not be described as providing insured delivery unless a specific integrated service is shown in the reservation."] },
  ]} />;
}
