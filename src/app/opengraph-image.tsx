...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: 80, background: "#072F28", color: "white" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 24, color: "#E9BD50", fontSize: 34, letterSpacing: 5, textTransform: "uppercase" }}>GoldHub · UAE</div>
      <div style={{ marginTop: 35, maxWidth: 900, fontSize: 76, lineHeight: 1.05, fontWeight: 700, fontFamily: "serif" }}>Gold, clearly priced.</div>
