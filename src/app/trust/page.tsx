...
export const metadata: Metadata = {
  ...
  description: "How GoldHub verifies UAE gold shops, reviews listings and protects live-price reservations.",
...
const checks = [
  ...
  ["03", "Transparent pricing", "Gold value, making, certificates, stones, vendor premium, GoldHub fee and delivery are separated so the total can be understood."],
    ...
    <>
      <section className="relative overflow-hidden bg-jade-950 text-white">
        ...
        <div className="container-pro relative py-14 sm:py-20">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-relaxed text-white/65 sm:text-base">GoldHub verifies who is selling, shows how the price is formed and preserves the exact market snapshot used for every reservation.</p>
        </div>
      </section>
      ...
      <div className="container-pro py-12 sm:py-16">
        ...
        <section className="mt-10 grid gap-6 rounded-[2rem] bg-jade-50 p-6 sm:p-8 lg:grid-cols-2">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-ink-muted">
            ...
            <p>GoldHub Value Score compares disclosed non-gold costs with live gold value. It is not an appraisal, craftsmanship score or resale forecast.</p>
          </div>
        </section>
