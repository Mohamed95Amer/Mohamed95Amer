...
export default async function AccountRequestsPage() {
  ...
  const { data: requests } = await admin.from("buyer_requests").select("*, offers:buyer_request_offers(*, vendor:vendors(business_name, emirate, verification_status))").eq("customer_user_id", user.id).order("created_at", { ascending: false });
  return (
