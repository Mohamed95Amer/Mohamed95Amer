...
export const metadata: Metadata = { title: "Privacy policy", description: "How GoldHub handles customer, vendor and marketplace data.", alternates: { canonical: "/privacy" } };

export default function PrivacyPage() {
  return <PolicyPage eyebrow="Your information" title="Privacy policy" intro="GoldHub collects only the information needed to operate accounts, reservations, vendor verification and marketplace safety." sections={[
    ...
    { title: "Who receives information", paragraphs: ["A vendor receives the customer and reservation information needed to confirm and fulfil that vendor’s order. Infrastructure, authentication, hosting and storage providers process information on GoldHub’s behalf. We do not publish private vendor documents."] },
